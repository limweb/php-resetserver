...
$dbconfig = [
    'driver'   => 'sqlsrv',
    'host'     => $_ENV['DB_HOST'] ?? 'mssql',
    'port'     => $_ENV['DB_PORT'] ?? '1433',
    'database' => $_ENV['DB_NAME'] ?? 'master',
    'username' => $_ENV['DB_USER'] ?? 'sa',
    'password' => $_ENV['DB_PASS'] ?? 'YourStrong!Passw0rd',
    ...
    'encrypt' => true,
    'trust_server_certificate' => true, // This is important for self-signed certificates
];
